...
curl -o .repo/local_manifests/manifest_brcm_rpi.xml -L https://raw.githubusercontent.com/optimitytech/android_kernel_manifest/refs/heads/android-14.0/manifest_brcm_rpi.xml --create-dirs
```
